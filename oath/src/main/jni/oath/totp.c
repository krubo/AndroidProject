...
#include "oath.h"
#include "hotp.h"
#include "aux1.h"		/* _oath_strcmp_callback */
...
oath_totp_generate (const char *secret,
		    ...
		    time_t start_offset, unsigned int  digits, char *output_otp)
{
...
oath_totp_generate2 (const char *secret,
		     ...
		     unsigned int time_step_size,
		     time_t start_offset,
		     unsigned int digits, int flags, char *output_otp)
{
  uint64_t nts;
